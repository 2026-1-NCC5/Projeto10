...
from api.dependencies import get_db, get_current_user, require_admin, require_admin_or_coordinator
...
def list_users(
    ...
    return get_all_users(db, available_only=available is True)
